...
prevArticleTitle: "Foundations of trade"
nextArticleSlug: "riba-usure-explication"
nextArticleTitle: "Ribā in detail"
---
...
As a general rule, one cannot sell what does not yet exist (e.g. the fruit of a tree that has not yet blossomed). This rule avoids disputes arising from uncertainty.
*Legal exception:* The **salam** or **istiṣnāʿ** contract, where the Prophet (sws) permitted the sale of a future manufactured or agricultural good under conditions of extremely precise description.
...
:::info
### 💡 Foundational ḥadīth
The companion Ḥakīm ibn Ḥizām said to the Prophet (sws): *« O Messenger of Allah, a man comes to me to buy merchandise I do not own. May I sell it to him and then go buy it in the market? »*

The Prophet (sws) replied: **« Do not sell what you do not own. »**
(Reported by Abū Dāwūd, al-Tirmidhī — *ṣaḥīḥ* chain).
:::
...
The prohibition of gharar is why conventional commercial insurance (paying a certain premium against uncertain compensation) and derivative financial products (options, futures) are largely considered unlawful by contemporary *fiqh* academies.
:::
...
1. A contract requires **offer and acceptance** (ījāb and qabūl), clear and matching.
2. The item sold must be **lawful, owned by the seller, and deliverable**. « Do not sell what you do not own. »
3. Price, quantity, quality, and deadlines must be **known precisely** to avoid excessive uncertainty (gharar).
4. Hiding a defect is a grave sin that gives the buyer the legal right to cancel the transaction.
