...
export const metadata: Metadata = {
  title: "Les Voyelles Longues | Langue Arabe",
  ...
  return (
    <article className="container mx-auto px-4 lg:px-8 py-10 max-w-3xl">
      ...
      <header className="mb-10">
        ...
        <p className="text-xl text-muted-foreground">Alif, Waw, Ya</p>
      </header>
      <div className="prose prose-lg dark:prose-invert max-w-none text-muted-foreground">
        <p>
          Une fois les voyelles courtes maîtrisées, nous utilisons trois lettres de l'alphabet (Alif, Waw, Ya) 
          pour prolonger le son. L'allongement est très important en arabe, car il peut changer totalement le sens d'un mot.
        </p>
