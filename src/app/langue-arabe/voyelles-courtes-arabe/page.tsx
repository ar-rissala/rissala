  ...
  return (
    <article className="container mx-auto px-4 lg:px-8 py-10 max-w-3xl">
      ...
      <header className="mb-10">
        ...
        <p className="text-xl text-muted-foreground">Fatha, Kasra, Damma</p>
      </header>
      <div className="prose prose-lg dark:prose-invert max-w-none text-muted-foreground">
        <p>
          En arabe, les lettres représentent des consonnes. Ce sont de petits symboles placés au-dessus ou en dessous 
          de la lettre (les Harakat) qui vont déterminer s'il faut lire un son "A", "I" ou "OU".
        </p>
