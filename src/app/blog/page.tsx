    ...
    <div className="container mx-auto px-4 lg:px-8 py-16">
      <div className="flex flex-col md:flex-row justify-between items-end mb-12 border-b border-border/50 pb-8">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight mb-4 font-heading">Ressources & Éducation</h1>
          <p className="text-lg text-muted-foreground">Analyses des marchés, jurisprudences (fatawas), et guides complets pour exceller dans la finance islamique.</p>
        </div>
      ...
      <div className="mt-16 bg-muted/30 border border-border/50 rounded-2xl p-8 lg:p-12 text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-8">
        <div>
